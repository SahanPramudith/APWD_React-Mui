...
import getTextDecoration from "@mui/material/Link/getTextDecoration.js";
import routs from "../Comon/Navigation/rout.jsx";
import rout from "../Comon/Navigation/rout.jsx";
        ...
        <Box sx={{ display: 'flex' }}>
            ...
            <AppBar position="fixed" open={open}>
                <Toolbar>
                    ...
                    <Typography variant="h6" noWrap component="div" fontWeight={'bolder'}>
                        Acpt Addmin Panel
                    </Typography>
                </Toolbar>
            </AppBar>
            <Drawer variant="permanent" open={open}>
                ...
                <Divider />
                <List>
                    {/*{['Dasbord', 'Starred', ].map((text, index) => (*/}
